...
Without --interactive: Displays tickets in simple format [JIRA ID] [STATUS]
With --interactive: Opens interactive picker to select and work with tickets`,
		Run: func(cmd *cobra.Command, args []string) {
			...
			// Display in simple format or interactive mode based on flag
			if interactive {
	...
	cmd.Flags().BoolVar(&interactive, "interactive", false, "Enable interactive mode with picker")
